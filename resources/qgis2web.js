...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-1523518.327605, 6995891.582437, 5264837.996935, 10764631.760003], maxZoom: 28, minZoom: 6
    })
});


map.getView().fit([-1523518.327605, 6995891.582437, 5264837.996935, 10764631.760003], map.getSize());
